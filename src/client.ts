import { SpotifyTokenResponse, SpotifyTokenSuccess } from './types';
export = client;
...
async function client() {
  ...
  if (code) {
    ...
    const res: SpotifyTokenResponse = await json.json();
    ...
    const getToken = async (): Promise<SpotifyTokenSuccess> => {
